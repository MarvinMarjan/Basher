...
{
public:
	void _isfct_args(int args_c, std::string targ_args, std::map<std::string, std::string> color_pack);
	void _cmd_not_found(std::string cmd, std::map<std::string, std::string>);
